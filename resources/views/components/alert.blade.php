...
<div 
	...
	<div class="my-4 relative flex p-4 rounded-lg {{ $alertClass[$variant] }}" role="alert">
		...
		@if($close)
			<button class="focus:outline-none focus:shadow-outline ml-4 w-8 h-8 inline-flex p-1 rounded-full hover:bg-white text-gray-600" x-on:click="open = false">
