<div class="mb-5">	
    ...
    <div class="relative">
        <textarea
			id="{{ $id ?? $name }}" 
			autocomplete="off"
            class="form-input transition px-3 py-3 block w-full text-gray-800 bg-white font-sans rounded-lg text-left appearance-none focus:outline-none focus:shadow-outline bg-white shadow-sm border {{ $errors->has($name) ? ' border-red-500 bg-red-100' : ' border-gray-300' }}"
            name="{{ $name }}" 
