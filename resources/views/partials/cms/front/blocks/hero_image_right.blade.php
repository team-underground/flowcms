<div class="flex flex-wrap items-center flex-1 md:py-10">
	<div class="w-full md:w-1/2 px-4 text-center md:text-left">
		<div class="md:px-10" data-aos="fade-right">
			...
			@isset($pageblock->value['link_url'])
				<div class="my-6">
					<a href="{{ $pageblock->value['link_url'] }}" class="font-medium inline-flex justify-between rounded-lg px-6 py-3 bg-indigo-700 hover:bg-indigo-800 text-white transition items-center duration-300 ease-in-out">{{ $pageblock->value['link_text'] }}</a>
				</div>
			@endisset
		</div>
	</div>
